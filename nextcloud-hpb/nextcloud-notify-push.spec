...
%changelog
* Fri Sep 18 2026 Marco Bignami <m.bignami@unknown-domain.no-ip.net> 1.4.1-1
 - Updated package to upstream

* Mon May 25 2026 Marco Bignami <m.bignami@unknown-domain.no-ip.net> 1.3.3-1
 - Updated package to upstream

* Wed Apr 15 2026 Marco Bignami <m.bignami@unknown-domain.no-ip.net> 1.3.1-1
 - Updated package to upstream

* Mon Nov 03 2025 Marco Bignami <m.bignami@unknown-domain.no-ip.net> 1.2.1-1
 - Updated package to upstream
 
* Wed Aug 27 2025 Marco Bignami <m.bignami@unknown-domain.no-ip.net> 1.2.0-1
 - Updated package to upstream
